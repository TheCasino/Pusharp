...
namespace Pusharp.Models
{
    internal class DeviceModel
    {
        ...
        [ModelProperty("generated_nickname")]
        public bool GeneratedNickname { get; set; }

        [ModelProperty("fingerprint")]
        public string Fingerprint { get; set; }

        [ModelProperty("key_fingerprint")]
        public string KeyFingerprint { get; set; }

        [ModelProperty("pushable")]
        public bool Pushable { get; set; }

        [ModelProperty("has_sms")]
        public bool HasSms { get; set; }

        [ModelProperty("has_mms")]
        public bool HasMms { get; set; }

        [ModelProperty("icon")]
        public string Icon { get; set; }

        [ModelProperty("remote_files")]
